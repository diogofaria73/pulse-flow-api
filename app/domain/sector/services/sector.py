...
from app.domain.sector.repositories.sector import sector_repository
from app.domain.sector.schemas.sector import SectorCreate, SectorSearch, SectorUpdate
